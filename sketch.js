...
function preload()
{
  ...
  star_stars_img=loadImage('stars.png');
  star_one_img=loadImage('one_star.png');
  star_empty_img=loadImage('empty.png');
...
function setup() 
{
  ...
  star_score=createSprite(50,20,30,30)
  star_score.addAnimation('empty',star_empty_img)
  star_score.addAnimation('one',star_one_img)
  star_score.addAnimation('two',star_stars_img)
